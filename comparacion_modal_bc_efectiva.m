...
%figure;
plot(ks, unwrap(angle(reflection)), 'DisplayName', num2str(L), 'color', CM(ll,:))
...
if jj==2
	lgd = legend('Location','southeast', 'Box', 'on', 'edgecolor', 'white');
	lgd.Title.String = '$L/a$';
end
